...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [112:0] red_leds_s1_agent_rp_data;                                              // red_leds_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [112:0] green_leds_s1_agent_rp_data;                                            // green_leds_s1_agent:rp_data -> router_006:sink_data
	...
	wire          hexport2_s1_agent_rp_valid;                                             // hexport2_s1_agent:rp_valid -> router_007:sink_valid
	wire  [112:0] hexport2_s1_agent_rp_data;                                              // hexport2_s1_agent:rp_data -> router_007:sink_data
	wire          hexport2_s1_agent_rp_ready;                                             // router_007:sink_ready -> hexport2_s1_agent:rp_ready
	wire          hexport2_s1_agent_rp_startofpacket;                                     // hexport2_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          hexport2_s1_agent_rp_endofpacket;                                       // hexport2_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> red_leds_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // red_leds_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [7:0] router_005_src_channel;                                                 // router_005:src_channel -> red_leds_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] red_leds_s1_rsp_width_adapter_src_data;                                 // red_leds_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          red_leds_s1_rsp_width_adapter_src_ready;                                // rsp_demux_004:sink_ready -> red_leds_s1_rsp_width_adapter:out_ready
	wire    [7:0] red_leds_s1_rsp_width_adapter_src_channel;                              // red_leds_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire  [112:0] router_006_src_data;                                                    // router_006:src_data -> green_leds_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // green_leds_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [7:0] router_006_src_channel;                                                 // router_006:src_channel -> green_leds_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] green_leds_s1_rsp_width_adapter_src_data;                               // green_leds_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          green_leds_s1_rsp_width_adapter_src_ready;                              // rsp_demux_005:sink_ready -> green_leds_s1_rsp_width_adapter:out_ready
	wire    [7:0] green_leds_s1_rsp_width_adapter_src_channel;                            // green_leds_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire          router_007_src_valid;                                                   // router_007:src_valid -> hexport2_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_007_src_data;                                                    // router_007:src_data -> hexport2_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // hexport2_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [7:0] router_007_src_channel;                                                 // router_007:src_channel -> hexport2_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> hexport2_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> hexport2_s1_rsp_width_adapter:in_endofpacket
	wire          hexport2_s1_rsp_width_adapter_src_valid;                                // hexport2_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [148:0] hexport2_s1_rsp_width_adapter_src_data;                                 // hexport2_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          hexport2_s1_rsp_width_adapter_src_ready;                                // rsp_demux_006:sink_ready -> hexport2_s1_rsp_width_adapter:out_ready
	wire    [7:0] hexport2_s1_rsp_width_adapter_src_channel;                              // hexport2_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          hexport2_s1_rsp_width_adapter_src_startofpacket;                        // hexport2_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          hexport2_s1_rsp_width_adapter_src_endofpacket;                          // hexport2_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> red_leds_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // red_leds_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> red_leds_s1_cmd_width_adapter:in_channel
	...
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> green_leds_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // green_leds_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> green_leds_s1_cmd_width_adapter:in_channel
	...
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> hexport2_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> hexport2_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // hexport2_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> hexport2_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> hexport2_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> hexport2_s1_cmd_width_adapter:in_endofpacket
	...
	wire          hexport2_s1_agent_rdata_fifo_src_valid;                                 // hexport2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] hexport2_s1_agent_rdata_fifo_src_data;                                  // hexport2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          hexport2_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_006:in_0_ready -> hexport2_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                      // avalon_st_adapter_006:out_0_valid -> hexport2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                       // avalon_st_adapter_006:out_0_data -> hexport2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                      // hexport2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                      // avalon_st_adapter_006:out_0_error -> hexport2_s1_agent:rdata_fifo_sink_error
