...
module pcihellocore_mm_interconnect_0 (
	...
	wire          push_buttons_s1_agent_rp_valid;                                         // push_buttons_s1_agent:rp_valid -> router_003:sink_valid
	wire  [112:0] push_buttons_s1_agent_rp_data;                                          // push_buttons_s1_agent:rp_data -> router_003:sink_data
	wire          push_buttons_s1_agent_rp_ready;                                         // router_003:sink_ready -> push_buttons_s1_agent:rp_ready
	wire          push_buttons_s1_agent_rp_startofpacket;                                 // push_buttons_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          push_buttons_s1_agent_rp_endofpacket;                                   // push_buttons_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	wire          red_leds_s1_agent_rp_valid;                                             // red_leds_s1_agent:rp_valid -> router_004:sink_valid
	wire  [112:0] red_leds_s1_agent_rp_data;                                              // red_leds_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [112:0] green_leds_s1_agent_rp_data;                                            // green_leds_s1_agent:rp_data -> router_005:sink_data
	...
	wire          hexport2_s1_agent_rp_valid;                                             // hexport2_s1_agent:rp_valid -> router_006:sink_valid
	wire  [112:0] hexport2_s1_agent_rp_data;                                              // hexport2_s1_agent:rp_data -> router_006:sink_data
	wire          hexport2_s1_agent_rp_ready;                                             // router_006:sink_ready -> hexport2_s1_agent:rp_ready
	wire          hexport2_s1_agent_rp_startofpacket;                                     // hexport2_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire          hexport2_s1_agent_rp_endofpacket;                                       // hexport2_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	wire          inport_s1_agent_rp_valid;                                               // inport_s1_agent:rp_valid -> router_007:sink_valid
	wire  [112:0] inport_s1_agent_rp_data;                                                // inport_s1_agent:rp_data -> router_007:sink_data
	wire          inport_s1_agent_rp_ready;                                               // router_007:sink_ready -> inport_s1_agent:rp_ready
	wire          inport_s1_agent_rp_startofpacket;                                       // inport_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          inport_s1_agent_rp_endofpacket;                                         // inport_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          router_003_src_valid;                                                   // router_003:src_valid -> push_buttons_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_003_src_data;                                                    // router_003:src_data -> push_buttons_s1_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                                   // push_buttons_s1_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [7:0] router_003_src_channel;                                                 // router_003:src_channel -> push_buttons_s1_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                                           // router_003:src_startofpacket -> push_buttons_s1_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                             // router_003:src_endofpacket -> push_buttons_s1_rsp_width_adapter:in_endofpacket
	wire          push_buttons_s1_rsp_width_adapter_src_valid;                            // push_buttons_s1_rsp_width_adapter:out_valid -> rsp_demux_002:sink_valid
	wire  [148:0] push_buttons_s1_rsp_width_adapter_src_data;                             // push_buttons_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	wire          push_buttons_s1_rsp_width_adapter_src_ready;                            // rsp_demux_002:sink_ready -> push_buttons_s1_rsp_width_adapter:out_ready
	wire    [7:0] push_buttons_s1_rsp_width_adapter_src_channel;                          // push_buttons_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	wire          push_buttons_s1_rsp_width_adapter_src_startofpacket;                    // push_buttons_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_002:sink_startofpacket
	wire          push_buttons_s1_rsp_width_adapter_src_endofpacket;                      // push_buttons_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_002:sink_endofpacket
	wire          router_004_src_valid;                                                   // router_004:src_valid -> red_leds_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_004_src_data;                                                    // router_004:src_data -> red_leds_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                   // red_leds_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [7:0] router_004_src_channel;                                                 // router_004:src_channel -> red_leds_s1_rsp_width_adapter:in_channel
	wire          router_004_src_startofpacket;                                           // router_004:src_startofpacket -> red_leds_s1_rsp_width_adapter:in_startofpacket
	wire          router_004_src_endofpacket;                                             // router_004:src_endofpacket -> red_leds_s1_rsp_width_adapter:in_endofpacket
	wire          red_leds_s1_rsp_width_adapter_src_valid;                                // red_leds_s1_rsp_width_adapter:out_valid -> rsp_demux_003:sink_valid
	wire  [148:0] red_leds_s1_rsp_width_adapter_src_data;                                 // red_leds_s1_rsp_width_adapter:out_data -> rsp_demux_003:sink_data
	wire          red_leds_s1_rsp_width_adapter_src_ready;                                // rsp_demux_003:sink_ready -> red_leds_s1_rsp_width_adapter:out_ready
	wire    [7:0] red_leds_s1_rsp_width_adapter_src_channel;                              // red_leds_s1_rsp_width_adapter:out_channel -> rsp_demux_003:sink_channel
	wire          red_leds_s1_rsp_width_adapter_src_startofpacket;                        // red_leds_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_003:sink_startofpacket
	wire          red_leds_s1_rsp_width_adapter_src_endofpacket;                          // red_leds_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_003:sink_endofpacket
	wire          router_005_src_valid;                                                   // router_005:src_valid -> green_leds_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> green_leds_s1_rsp_width_adapter:in_data
	wire          router_005_src_ready;                                                   // green_leds_s1_rsp_width_adapter:in_ready -> router_005:src_ready
	wire    [7:0] router_005_src_channel;                                                 // router_005:src_channel -> green_leds_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] green_leds_s1_rsp_width_adapter_src_data;                               // green_leds_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          green_leds_s1_rsp_width_adapter_src_ready;                              // rsp_demux_004:sink_ready -> green_leds_s1_rsp_width_adapter:out_ready
	wire    [7:0] green_leds_s1_rsp_width_adapter_src_channel;                            // green_leds_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire          router_006_src_valid;                                                   // router_006:src_valid -> hexport2_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_006_src_data;                                                    // router_006:src_data -> hexport2_s1_rsp_width_adapter:in_data
	wire          router_006_src_ready;                                                   // hexport2_s1_rsp_width_adapter:in_ready -> router_006:src_ready
	wire    [7:0] router_006_src_channel;                                                 // router_006:src_channel -> hexport2_s1_rsp_width_adapter:in_channel
	wire          router_006_src_startofpacket;                                           // router_006:src_startofpacket -> hexport2_s1_rsp_width_adapter:in_startofpacket
	wire          router_006_src_endofpacket;                                             // router_006:src_endofpacket -> hexport2_s1_rsp_width_adapter:in_endofpacket
	wire          hexport2_s1_rsp_width_adapter_src_valid;                                // hexport2_s1_rsp_width_adapter:out_valid -> rsp_demux_005:sink_valid
	wire  [148:0] hexport2_s1_rsp_width_adapter_src_data;                                 // hexport2_s1_rsp_width_adapter:out_data -> rsp_demux_005:sink_data
	wire          hexport2_s1_rsp_width_adapter_src_ready;                                // rsp_demux_005:sink_ready -> hexport2_s1_rsp_width_adapter:out_ready
	wire    [7:0] hexport2_s1_rsp_width_adapter_src_channel;                              // hexport2_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	wire          hexport2_s1_rsp_width_adapter_src_startofpacket;                        // hexport2_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_005:sink_startofpacket
	wire          hexport2_s1_rsp_width_adapter_src_endofpacket;                          // hexport2_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_005:sink_endofpacket
	wire          router_007_src_valid;                                                   // router_007:src_valid -> inport_s1_rsp_width_adapter:in_valid
	wire  [112:0] router_007_src_data;                                                    // router_007:src_data -> inport_s1_rsp_width_adapter:in_data
	wire          router_007_src_ready;                                                   // inport_s1_rsp_width_adapter:in_ready -> router_007:src_ready
	wire    [7:0] router_007_src_channel;                                                 // router_007:src_channel -> inport_s1_rsp_width_adapter:in_channel
	wire          router_007_src_startofpacket;                                           // router_007:src_startofpacket -> inport_s1_rsp_width_adapter:in_startofpacket
	wire          router_007_src_endofpacket;                                             // router_007:src_endofpacket -> inport_s1_rsp_width_adapter:in_endofpacket
	wire          inport_s1_rsp_width_adapter_src_valid;                                  // inport_s1_rsp_width_adapter:out_valid -> rsp_demux_006:sink_valid
	wire  [148:0] inport_s1_rsp_width_adapter_src_data;                                   // inport_s1_rsp_width_adapter:out_data -> rsp_demux_006:sink_data
	wire          inport_s1_rsp_width_adapter_src_ready;                                  // rsp_demux_006:sink_ready -> inport_s1_rsp_width_adapter:out_ready
	wire    [7:0] inport_s1_rsp_width_adapter_src_channel;                                // inport_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	wire          inport_s1_rsp_width_adapter_src_startofpacket;                          // inport_s1_rsp_width_adapter:out_startofpacket -> rsp_demux_006:sink_startofpacket
	wire          inport_s1_rsp_width_adapter_src_endofpacket;                            // inport_s1_rsp_width_adapter:out_endofpacket -> rsp_demux_006:sink_endofpacket
	...
	wire          cmd_mux_002_src_valid;                                                  // cmd_mux_002:src_valid -> push_buttons_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_002_src_data;                                                   // cmd_mux_002:src_data -> push_buttons_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                  // push_buttons_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                // cmd_mux_002:src_channel -> push_buttons_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_002_src_startofpacket;                                          // cmd_mux_002:src_startofpacket -> push_buttons_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                            // cmd_mux_002:src_endofpacket -> push_buttons_s1_cmd_width_adapter:in_endofpacket
	...
	wire          cmd_mux_003_src_valid;                                                  // cmd_mux_003:src_valid -> red_leds_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_003_src_data;                                                   // cmd_mux_003:src_data -> red_leds_s1_cmd_width_adapter:in_data
	wire          cmd_mux_003_src_ready;                                                  // red_leds_s1_cmd_width_adapter:in_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                // cmd_mux_003:src_channel -> red_leds_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_003_src_startofpacket;                                          // cmd_mux_003:src_startofpacket -> red_leds_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                            // cmd_mux_003:src_endofpacket -> red_leds_s1_cmd_width_adapter:in_endofpacket
	...
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> green_leds_s1_cmd_width_adapter:in_data
	wire          cmd_mux_004_src_ready;                                                  // green_leds_s1_cmd_width_adapter:in_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> green_leds_s1_cmd_width_adapter:in_channel
	...
	wire          cmd_mux_005_src_valid;                                                  // cmd_mux_005:src_valid -> hexport2_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_005_src_data;                                                   // cmd_mux_005:src_data -> hexport2_s1_cmd_width_adapter:in_data
	wire          cmd_mux_005_src_ready;                                                  // hexport2_s1_cmd_width_adapter:in_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> hexport2_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_005_src_startofpacket;                                          // cmd_mux_005:src_startofpacket -> hexport2_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                            // cmd_mux_005:src_endofpacket -> hexport2_s1_cmd_width_adapter:in_endofpacket
	...
	wire          cmd_mux_006_src_valid;                                                  // cmd_mux_006:src_valid -> inport_s1_cmd_width_adapter:in_valid
	wire  [148:0] cmd_mux_006_src_data;                                                   // cmd_mux_006:src_data -> inport_s1_cmd_width_adapter:in_data
	wire          cmd_mux_006_src_ready;                                                  // inport_s1_cmd_width_adapter:in_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> inport_s1_cmd_width_adapter:in_channel
	wire          cmd_mux_006_src_startofpacket;                                          // cmd_mux_006:src_startofpacket -> inport_s1_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                            // cmd_mux_006:src_endofpacket -> inport_s1_cmd_width_adapter:in_endofpacket
	...
	wire          hexport2_s1_agent_rdata_fifo_src_valid;                                 // hexport2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] hexport2_s1_agent_rdata_fifo_src_data;                                  // hexport2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          hexport2_s1_agent_rdata_fifo_src_ready;                                 // avalon_st_adapter_005:in_0_ready -> hexport2_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                      // avalon_st_adapter_005:out_0_valid -> hexport2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                       // avalon_st_adapter_005:out_0_data -> hexport2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                      // hexport2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                      // avalon_st_adapter_005:out_0_error -> hexport2_s1_agent:rdata_fifo_sink_error
	wire          inport_s1_agent_rdata_fifo_src_valid;                                   // inport_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] inport_s1_agent_rdata_fifo_src_data;                                    // inport_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          inport_s1_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter_006:in_0_ready -> inport_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                      // avalon_st_adapter_006:out_0_valid -> inport_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                       // avalon_st_adapter_006:out_0_data -> inport_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                      // inport_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                      // avalon_st_adapter_006:out_0_error -> inport_s1_agent:rdata_fifo_sink_error
